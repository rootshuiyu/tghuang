        ...
        add: function () {
            ...
            $(document).on('change', "select[name='table']", function () {
                ...
                Fast.api.ajax({
                    ...
                    tableName = $(that).val();
                    stringWithoutPrefix = tableName.replace(/^hub_/, '');
                    stringWithoutUnderscores = stringWithoutPrefix.replace(/_/g, '');
                    //finalString = stringWithoutUnderscores.charAt(0).toUpperCase() + stringWithoutUnderscores.slice(1);
                    
                    $('input[name=controller]').val('yunos/'+ stringWithoutUnderscores);
