...
class Backend extends Controller
{
    ...
    public function _initialize()
    {
        ...
        $this->assign('seachlist', $this->seachlist);
    ...
    protected function pro($field,$data = [])
    {
    ...
    protected function is_boss()
    {
        
        $group = $this->auth->getGroups($this->auth->id);
    ...
    protected function limitQuery($field = 'user_id',$my = false)
    {
        ...
        $ids = $model->where('pid',$this->auth->id)->column('id');
        $ids[] = $this->auth->id;
    ...
    protected function limitQuerySup()
    {
        ...
        return ['sup_user_id' => $this->auth->id];
    ...
    protected function model($name = null)
    {
        ...
        $class = '\\app\\admin\\model\\yunos\\' . $name;
        $app = new $class;
        return $app;
        
    }
    
    protected function moduled($app,$function,$data = [])
    {
        $re = [
            'app'    => $app,
            'action' => $function,
        ...
        \yunos\AsyncQueue::pushTask('AsyncWork', $re);
